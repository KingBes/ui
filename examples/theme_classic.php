 ...
 * 经典主题示例（Windows 特有）。
 *
 * 不加载 ComCtl32 v6 manifest，呈现 Windows 9x 时代经典灰控件外观。
 * 适合远程桌面、截图自动化测试等场景。
 *
 * 对比其他主题示例：
 ...
 *
 * 运行：php -d ffi.enable=true examples/theme_classic.php
 */
...
$win = new Window("经典主题 - Classic", 480, 380);
...
$root->add(new Label($root, "Theme::CLASSIC", Label::ALIGN_CENTER));
