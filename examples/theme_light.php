 ...
 * 浅色主题示例（Windows 特有）。
 *
 * 启用 ComCtl32 v6 视觉样式 + uxtheme SetPreferredAppMode(ForceLight)。
 *
 * 对比其他主题示例：
 ...
 *   theme_dark.php     强制深色
 *
 * 运行：php -d ffi.enable=true examples/theme_light.php
 */
...
$win = new Window("浅色主题 - Light", 480, 380);
...
$root->add(new Label($root, "Theme::LIGHT", Label::ALIGN_CENTER));
